...
.  เวลาที่มีการแข่งขันมากสุด
.  ประเทศที่ยิงประตูครึ่งหลังเกิน 2 ประตู
.  สนามไหนที่ใช้ในการแข่งขันบอลโลกมากที่สุด
.  ประเทศทีมเหย้า(Home)ที่แข่งแล้วทำประตูได้มากที่สุดในครึ่งแรก
.  ประเทศทีมเยือน(Awey)ที่แข่งแล้วทำประตูได้น้อยที่สุดในครึ่งแรก
.  ประเทศที่ชนะได้ในการต่อเวลาพิเศษบ่อยสุด
.  สนามไหนถูกใช้ในช่วงเวลาเดียวกันมากที่สุด
.  ในการแข่งขันฟุตบอลโลกปีไหนที่ไม่มีผู้ชมเข้าร่วมเลย

...
worldcup$Stadium <- worldcup$Stadium %>% str_remove('申') %>% str_remove('申') %>% str_remove('??????') %>% str_remove('???') 
worldcup$City <- worldcup$City %>% str_remove('申') %>% str_remove('申') %>% str_remove('??????') %>% str_remove('???') 
worldcup$Referee <- worldcup$Referee %>% str_remove('申') %>% str_remove('申') %>% str_remove('??????') %>% str_remove('???') 
worldcup$Assistant.1 <- worldcup$Assistant.1 %>% str_remove('申') %>% str_remove('申') %>% str_remove('??????') %>% str_remove('???') 
worldcup$Assistant.2 <- worldcup$Assistant.2 %>% str_remove('申') %>% str_remove('申') %>% str_remove('??????') %>% str_remove('???')
View(worldcup)
#save as CSV

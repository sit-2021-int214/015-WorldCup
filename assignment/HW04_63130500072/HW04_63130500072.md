...
### Step 2 : Order ทั้งหมดในแต่ละปีมีจำนวนเท่าไหร่
...
### Step 3 : ผลรวมของการขายทั้งหมดเป็นในแต่ละภาคเท่าไหร่
...
4 West    710220.
```
### Step 4 : ลูกค้าที่มียอดการสั่งซื้อเกิน 10000 มีทั้งหมดเท่าไหร่

```
superstore %>% group_by(`Customer Name`) %>%  summarise(Total = sum(Sales)) %>% filter(Total > 10000)
```

Result : ลูกค้าที่มียอดสั้งซื้อเกิน 10000 มีจำนวนเท่ากับ 

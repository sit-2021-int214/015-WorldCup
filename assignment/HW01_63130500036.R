...
length(marvel_movies)#27 ใช้ Length เพื่อดูสมาชิกใน vector
marvel_movies[19]#"Avengers: Infinity War ใช้marvel_movies[index] เพื่อแทนค่าตำแหน่งที่เราต้องการหา
years # 2017 and 2021 ใช้การนับ
